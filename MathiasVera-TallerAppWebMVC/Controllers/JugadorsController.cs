...
namespace MathiasVera_TallerAppWebMVC.Controllers
{
    public class JugadorsController : Controller
    {
        private readonly MathiasVera_TallerAppWebMVCContext _context;

        public JugadorsController(MathiasVera_TallerAppWebMVCContext context)
        {
            _context = context;
        }
        ...
        {
            var mathiasVera_TallerAppWebMVCContext = _context.Jugador.Include(j => j.Equipo);
            return View(await mathiasVera_TallerAppWebMVCContext.ToListAsync());
        }
